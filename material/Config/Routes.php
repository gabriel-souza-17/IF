...
return [
    ...
    '/projeto/enderecos' => ['Enderecos', 'index'],
    '/projeto/enderecos/new' => ['Enderecos', 'new'],
    '/projeto/enderecos/index' => ['Enderecos', 'index'],
    '/projeto/enderecos/edit/{id}' => ['Enderecos', 'edit'],
    '/projeto/enderecos/delete/{id}' => ['Enderecos', 'delete'],
    '/projeto/enderecos/save' => ['Enderecos', 'save'],
    '/projeto/enderecos/edit_save' => ['Enderecos', 'edit_save'],
    '/projeto/enderecos/search' => ['Enderecos', 'search'],
